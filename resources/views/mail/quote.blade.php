...
<body>
    <p style="text-align: center;"><span style="font-size: 18pt;"><strong>B&Aacute;O GI&Aacute; SẢN PHẨM</strong></span>
    </p>
    <p style="text-align: center;"><span
            style="font-size: 14pt;"><strong>{{ Carbon\Carbon::parse($quote->quote_date)->format('d/m/Y') }}</strong></span>
    </p>
    ...
    <ul style="list-style-type: circle;">
        ...
        <li style="text-align: justify;">Ph&iacute; vận chuyển: {{ number_format($quote->shipping_fee,2) }}</li>
